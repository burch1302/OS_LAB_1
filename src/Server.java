...
public class Server {
    ...
    public void run() throws IOException {
        ...
        try {
            ...
            String path = "/Users/burch/OneDrive/Рабочий стол/Прога в унике/OSLAB1/Lab1/bin";
                ...
                if (sChannel != null) {
                    ...
                    if (parsedData[0].equals("Function")) {
                        ...
                        if (parsedData[1].equals("F")) {
                            if (!endedG)
                                System.out.println("Function G interrupts");
                        } else {
                            if (!endedF)
                                System.out.println("Function F interrupts");
                        }
                        end = System.nanoTime();
